...
EXPLAIN SELECT * FROM tbl_menu a
JOIN tbl_category b ON ( a.category_code = b.category_code)
WHERE category_name = (SELECT category_name FROM tbl_category WHERE a.category_code = 4);
...
select * from students where name = '학생13432';
select * from students where id = 13432;
